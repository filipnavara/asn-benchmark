	...
	internal static class AsnSerializer
	{
		...
		private static object DeserializeChoice(AsnReader reader, Type typeT)
		{
			...
			if (lookup.TryGetValue(key, out LinkedList<FieldInfo> fieldInfos))
			{
				...
				object currentObject = FormatterServices.GetUninitializedObject(currentField.DeclaringType);
				...
				while (currentNode.Previous != null)
				{
					...
					object nextObject = FormatterServices.GetUninitializedObject(currentField.DeclaringType);
